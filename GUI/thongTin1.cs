...
namespace GUI
{
    public partial class thongTin1 : UserControl
    {
        ...
        public void setThongTin()
        {
            ...
            lbl_sdt.Text = Sdt;
            lbl_ten.Text = TenNV;
            pictureBox1.Image = new Bitmap(Icon);
        }
        ...
        public delegate NhanVien ThongTinClickedDelegate(string maNV);
        ...
        public NhanVien getNVByMa()
        {
            NhanVien a = new NhanVien();
            NhanVien nv = a.get1NhanVienByMa(MaNV);
            return nv;
        }
